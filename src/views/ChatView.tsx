...
export default function ChatView() {
  ...
  const sendChatMessage = () => {
    ...
    if (!text) return;
    // Client-side spam koruması — 300ms throttle + duplicate suppression
    const now = Date.now();
            ...
            <div className="relative flex-1 flex flex-col min-h-0 overflow-hidden">
              ...
              <div className="relative z-[1] flex-1">
                <VoiceParticipants
                  ...
                  isMuted={isMuted}
                  isDeafened={isDeafened}
                  isVoiceBanned={!!currentUser.isVoiceBanned}
                  ...
                  cardScale={cardScale}
                  cardStyle={cardStyle}
                  onProfileClick={(userId, x, y) => setProfilePopup({ userId, x, y })}
                  ...
                  chatMuted={chatMuted}
                  onToggleChatMuted={() => setChatMuted(!chatMuted)}
                  editingMsgId={editingMsgId}
                  editingText={editingText}
                  onEditingTextChange={setEditingText}
                  onStartEdit={startEditMessage}
                  onSaveEdit={saveEditMessage}
                  onCancelEdit={() => { setEditingMsgId(null); setEditingText(''); }}
