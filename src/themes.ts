...
export const themes: Record<ThemeKey, AppTheme> = {
  ...
  arcticWhite: {
    ...
    description: "Temiz beyaz zemin, koyu metin, beyaz aksan.",
    isLight: true,
    primary: "#FFFFFF", secondary: "#FFFFFF", accent: "#FFFFFF",
    background: "#FFFFFF", backgroundElevated: "#F5F8FC",
    surface: "#FFFFFF", panel: "#FFFFFF",
    panelHover: "rgba(255,255,255,0.10)", panelActive: "rgba(255,255,255,0.16)",
    borderSubtle: "rgba(13,13,13,0.12)", divider: "rgba(13,13,13,0.08)",
    glow: "rgba(255,255,255,0.18)",
    textPrimary: "#0D0D0D", textSecondary: "#3F4652",
    textMuted: "#8B95A3", textOnPrimary: "#111111", textOnAccent: "#111111",
    buttonPrimaryBg: "#FFFFFF", buttonPrimaryHover: "#F3F4F6", buttonPrimaryText: "#111111",
    buttonGhostBg: "rgba(255,255,255,0.10)", buttonGhostHover: "rgba(255,255,255,0.16)", buttonGhostText: "#0D0D0D",
    ...
    iconPrimary: "#FFFFFF", iconSecondary: "#3F4652",
    selection: "rgba(255,255,255,0.16)", scrollbarThumb: "rgba(255,255,255,0.35)",
