...
export const themes: Record<ThemeKey, AppTheme> = {
  ...
  arcticWhite: {
    key: "arcticWhite", name: "Varsayılan Açık",
    description: "Temiz beyaz zemin, koyu metin, koyu bordo aksan.",
    isLight: true,
    primary: "#250707", secondary: "#250707", accent: "#250707",
    background: "#FFFFFF", backgroundElevated: "#F5F8FC",
    surface: "#FFFFFF", panel: "#FFFFFF",
    panelHover: "rgba(37,7,7,0.06)", panelActive: "rgba(37,7,7,0.10)",
    borderSubtle: "rgba(13,13,13,0.12)", divider: "rgba(13,13,13,0.08)",
    glow: "rgba(37,7,7,0.16)",
    textPrimary: "#0D0D0D", textSecondary: "#3F4652",
    textMuted: "#8B95A3", textOnPrimary: "#FFFFFF", textOnAccent: "#FFFFFF",
    buttonPrimaryBg: "#250707", buttonPrimaryHover: "#3A0B0B", buttonPrimaryText: "#FFFFFF",
    buttonGhostBg: "rgba(37,7,7,0.06)", buttonGhostHover: "rgba(37,7,7,0.10)", buttonGhostText: "#0D0D0D",
    inputBg: "#FFFFFF", inputBorder: "rgba(13,13,13,0.12)",
    inputText: "#0D0D0D", inputPlaceholder: "#8B95A3",
    success: "#00A240", warning: "#B26A00", danger: "#E02E2A",
    successText: "#14532D", warningText: "#78350F", dangerText: "#7F1D1D",
    iconPrimary: "#250707", iconSecondary: "#3F4652",
    selection: "rgba(37,7,7,0.12)", scrollbarThumb: "rgba(37,7,7,0.35)",
    elevatedPanel: "#FFFFFF", elevatedPanelHover: "#F5F8FC",
    popoverBg: "#FFFFFF", popoverBorder: "rgba(13,13,13,0.10)",
    popoverText: "#0D0D0D", popoverTextSecondary: "#3F4652",
    popoverShadow: "0 18px 48px rgba(13,13,13,0.14)",
  },
};
